...
const validator_cfg_1 = require("../api/validator_cfg");
...
class RemoveComponent extends command_1.Command {
    async run() {
        ...
        const validator = new validator_cfg_1.ReactCMConfigValidator();
        const backend = new remove_backend_1.RemoveBackend(new config_loader_1.ReactCMConfigLoader(new config_finder_1.ReactCMConfigFinder(), validator), args);
